...
Output: pictures/fig77_5solvers_comparison.pdf
"""
...
CASES = [
    {
        ...
        "solvers": {
            ...
            "Eigen_PCG": "RayleighBenard/RayleighBenard_eigen_pcg_1_1_Output_1_1",
        },
    },
    {
        "label": "FT 100×50",
        "solvers": {
            ...
            "Eigen_PCG": "FluidTrap/FluidTrap_s100_eigen_pcg_1_1_Output_1_1",
        },
    },
    {
        "label": "LDC 50×50",
        "solvers": {
            ...
            "Eigen_PCG": "LidDrivenCavity50/LidDrivenCavity50_eigen_pcg_1_1_Output_1_1",
        },
    },
]
...
fig1.suptitle("SOR vs CG vs PCG_SSOR vs Eigen_CG vs Eigen_PCG — 1×1, warm start",
...
out = os.path.join(PICTURES, "fig77_5solvers_comparison.pdf")
