"""
Strong Scaling Analysis — 100×50 Fluid Trap
...
SOR_CONFIGS = [
    ("FluidTrap_sor_1_1", "SOR (1×1)", 1, "1×1", "-",  "#2196F3"),
    ("FluidTrap_sor_2_2", "SOR (2×2)", 4, "2×2", "--", "#FF9800"),
    ("FluidTrap_sor_4_1", "SOR (4×1)", 4, "4×1", ":",  "#9C27B0"),
]

CG_CONFIGS = [
    ("FluidTrap_cg_1_1", "CG (1×1)", 1, "1×1", "-",  "#4CAF50"),
    ("FluidTrap_cg_2_2", "CG (2×2)", 4, "2×2", "--", "#F44336"),
    ("FluidTrap_cg_4_1", "CG (4×1)", 4, "4×1", ":",  "#009688"),
]
...
iters_plot(combined_1_1,
           "SOR vs CG iterations/step — Fluid Trap 1×1",
           "plot_ft_sor_vs_cg_1_1.pdf")
...
plt.tight_layout()
for dest in [BASE, DOWNLOADS]:
    plt.savefig(os.path.join(dest, "plot_ft_walltime.pdf"), dpi=150)
print("  Saved: plot_ft_walltime.pdf")
plt.close()

# ---------------------------------------------------------------------------
# Plot 3: Speedup — SOR and CG, baseline = 1×1
# ---------------------------------------------------------------------------
...
plt.tight_layout()
for dest in [BASE, DOWNLOADS]:
    plt.savefig(os.path.join(dest, "plot_ft_speedup.pdf"), dpi=150)
print("  Saved: plot_ft_speedup.pdf")
plt.close()
