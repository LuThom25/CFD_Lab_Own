...
Output: pictures/fig78_5solvers_large.pdf
"""
...
CASES = [
    {
        ...
        "solvers": {
            ...
            "Eigen_PCG": "RayleighBenard/RayleighBenard_eigen_pcg_80x36_1_1_Output_1_1",
        },
    },
    {
        "label": "FT 200×100",
        "solvers": {
            ...
            "Eigen_PCG": "FluidTrap/FluidTrap_200x100_eigen_pcg_1_1_Output_1_1",
        },
    },
    {
        "label": "LDC 100×100",
        "solvers": {
            ...
            "Eigen_PCG": "LidDrivenCavity50/LidDrivenCavity100_eigen_pcg_1_1_Output_1_1",
        },
    },
]

SOLVERS = ["SOR", "CG", "PCG_SSOR", "Eigen_CG", "Eigen_PCG"]
COLORS  = {"SOR": "#f28e2b", "CG": "#4e79a7", "PCG_SSOR": "#59a14f", "Eigen_CG": "#e15759", "Eigen_PCG": "#76b7b2"}
LABELS  = {"SOR": "SOR", "CG": "CG (ours)", "PCG_SSOR": "PCG_SSOR (ours)", "Eigen_CG": "Eigen CG", "Eigen_PCG": "Eigen PCG (IC)"}
...
fig1.suptitle("SOR vs CG vs PCG_SSOR vs Eigen_CG vs Eigen_PCG — large grids (2× small), 1×1, warm start",
...
out = os.path.join(PICTURES, "fig78_5solvers_large.pdf")
